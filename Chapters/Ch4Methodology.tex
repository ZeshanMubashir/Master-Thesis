...
training and evaluation. For this data preproceessing and augmentation techniques
...
Pillow: A user-friendly library forked from the Python Imaging Library (PIL) that simplifies image processing in Python.
...
detection task in floating solar PVs, the pre-trained  and Vision Transformer
...
principles of transformers, originally designed for (NLP),
...
on a given task, such as classification. Common evaluation metrics
...
context of anomaly detection in solar PVs, evaluation metrics are crucial
