...
\begin{table}[htbp]
    \centering
    \begin{tabular}{|>{\centering\arraybackslash}l|>{\centering\arraybackslash}c|>{\centering\arraybackslash}c|>{\centering\arraybackslash}p{7cm}|>{\centering\arraybackslash}c|}
        \hline
        \textbf{Class} & \textbf{No. of Images} & \textbf{\%} & \textbf{Description} & \textbf{Images} \\
        \hline
        Cell           & 1,877                  & 9.39\%      & Hot spot occurring with square geometry in a single cell.                & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\ 
        \hline
        Cell-Multi     & 1,288                  & 6.44\%      & Hot spots occurring with square geometry in multiple cells.               & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Cracking       & 941                    & 4.71\%      & Module anomaly caused by cracking on the module surface.                  & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Hot-Spot       & 251                    & 1.26\%      & Hot spot on a thin film module.                                           & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Hot-Spot-Multi & 247                    & 1.24\%      & Multiple hot spots on a thin film module.                                 & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Shadowing      & 1056                   & 5.28\%      & Sunlight obstructed by vegetation, man-made structures, or adjacent rows. & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Diode          & 1,499                  & 7.50\%      & Activated bypass diode, typically 1/3 of the module.                      & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Diode-Multi    & 175                    & 0.88\%      & Multiple activated bypass diodes, typically affecting 2/3 of the module.  & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Vegetation     & 1,639                  & 8.20\%      & Panels blocked by vegetation.                                             & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Soiling        & 205                    & 1.03\%      & Dirt, dust, or other debris on the surface of the module.                 & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        Offline-Module & 828                    & 4.14\%      & The Entire module is heated.                                              & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
        No-Anomaly     & 10,000                 & 50.03\%     & Nominal solar module.                                                     & \includegraphics[width=0.8cm]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
        \hline
    \end{tabular}

    \caption{Overview of the IR Dataset}

    % Add a Figure for the Dataset distribution
    \label{tab:dataset_overview}
\end{table}


It is important to note that the dataset contains 10,000 images of nominal solar modules and 10,000 images of 11 different
types of anomalies, resulting in a total of 20,000 images. The dataset is perfectly
balanced for 2 class classification (Anomaly vs No-Anomaly), with each class containing an equal number of images. But for multi-class classification, the
...
training and evaluation. For this data preprocessing and augmentation techniques
...
The dataset comprises 12 distinct classes, each representing different conditions
or anomalies that can occur in solar panel systems:
...
\begin{itemize}
    ...
    \item \textbf{Hot-Spot} - Hot spot on a thin film module. Hot spots are localized areas of elevated temperature that can occur due to various factors such as manufacturing defects, partial shading, or electrical mismatches within the solar cell. These thermal anomalies can significantly impact the performance and longevity of solar modules by causing power losses and potential damage to the affected cells.
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.25\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png}
        \caption{Example of a Hot-Spot anomaly in a thin film module}
        \label{fig:hot_spot_example}
    \end{figure}
...
\begin{longtable}{ll}
\caption{Sample images from each class in the dataset.} \label{tab:sample_images} \\
\toprule \textbf{Class Name} & \textbf{Sample Image} \\
\midrule
\endfirsthead
...
Cell & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Cell Multi & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Cracking & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Diode & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Diode Multi & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Hot Spot & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Hot Spot Multi & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
No Anomaly & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Offline Module & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Shadowing & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Soiling & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Vegetation & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Water Damage & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
Corrosion & \includegraphics[width=0.08\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png} \\
\end{longtable}

Table \ref{tab:sample_images} presents sample images from each of the 12 classes in the dataset, arranged in alphabetical order. These visual examples demonstrate the distinct characteristics and patterns associated with each type of anomaly or normal condition in solar PV panels. The images help illustrate the visual differences between various anomaly types, which is crucial for understanding the classification challenges and the effectiveness of the deep learning models in distinguishing between these classes.
...
models. This process may include tasks such as data cleaning, normalization, feature extraction,
...
All images in the dataset were resized to a consistent resolution of 160$\times$160 pixels
to ensure uniformity across the training data. This standardization is essential
for batch processing and maintaining consistent input dimensions for the neural
...
flipping, and cropping for images, or adding noise and changing pitch for audio data. By
...
\begin{table}[H]
\centering
\caption{Data Augmentation Techniques Applied}
\label{tab:augmentation_techniques}
\begin{tabular}{lccc}
\toprule
\textbf{Technique} & \textbf{Parameter Range} & \textbf{Classes Applied} & \textbf{Images Generated} \\
\midrule
Rotation & ±15° & All minority classes & 2,000 \\
Horizontal Flip & 50\% probability & All classes & 1,500 \\
Brightness Adjustment & ±20\% & All classes & 1,000 \\
Contrast Enhancement & 0.8-1.2 & Hot-Spot classes & 800 \\
Gaussian Noise & $\sigma=0.01$ & All classes & 1,200 \\
Shear Transformation & ±10° & Diode classes & 600 \\
Zoom & 0.9-1.1 & Cell classes & 900 \\
\bottomrule
\end{tabular}
\end{table}

Table \ref{tab:augmentation_techniques} summarizes the specific data augmentation techniques applied to address class imbalance in the dataset. These transformations were strategically applied to minority classes to improve overall model performance and reduce bias towards majority classes.

\subsubsection{Online Data Augmentation}
...
The dataset is split into three parts: training, validation, and test sets. The
training set is used to train the model, the validation set is used to tune
hyperparameters and prevent overfitting, and the test set is used to evaluate the
final model's performance. A common split ratio is 70\% for training, 15\% for
validation, and 15\% for testing, but this can vary depending on the dataset size
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        Integrated Graphics & Intel\textsuperscript{\textregistered} Iris\textsuperscript{\textregistered} Xe Graphics\\
                            & (2GB VRAM) \\
        \hline
    \end{tabular}
\end{table}
...
PyTorch is a popular open-source machine learning framework that provides a flexible
and intuitive platform for building and training deep learning models. It offers
dynamic computational graphs, making it easier to debug and experiment with different
architectures. PyTorch is widely used in research and industry applications for
computer vision, natural language processing, and other AI tasks.
...
\subsubsection{Unsharp Mask Filter}

The Unsharp Mask Filter is a technique used to enhance the edges of an image by
applying a mask to the image. It is a type of image processing technique that is
used to improve the contrast of an image. The Unsharp Mask Filter is a type of
image processing technique that is used to improve the contrast of an image.

% Add a figure for the Unsharp Mask Filter
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Figures/Solar PV/Original Dataset/image25_inferno.png}
    \caption{Unsharp Mask Filter}
    \label{fig:unsharp_mask_filter}
\end{figure}
...
Neural Networks (CNNs), Vision Transformers (ViTs), and Data-efficient Image
Transformer (DeiT) architectures.
...
\begin{tabular}{lcccc}
\toprule
\textbf{Model} & \textbf{Parameters} & \textbf{Input Size} & \textbf{Layers} & \textbf{Pre-trained} \\
\midrule
ResNet50 & 25.6M & 224$\times$224 & 50 & ImageNet \\
VGG16 & 138M & 224$\times$224 & 16 & ImageNet \\
EfficientNet-B0 & 5.3M & 224$\times$224 & Variable & ImageNet \\
Xception & 22.9M & 299$\times$299 & 71 & ImageNet \\
ViT-B32 & 88M & 224$\times$224 & 12 & ImageNet-21k \\
DeiT-B16 & 86M & 224$\times$224 & 12 & ImageNet \\
\bottomrule
\end{tabular}
\end{table}

Table \ref{tab:model_architectures} provides an overview of the different model architectures evaluated in this study, including their parameter counts, input requirements, architectural depth, and pre-training datasets. The diversity in model sizes and architectures allows for comprehensive comparison of different approaches to solar panel anomaly detection.
...
Table \ref{tab:hyperparameters} details the training configuration used across all models to ensure fair comparison. These hyperparameters were selected based on preliminary experiments and established best practices for deep learning on image classification tasks.

\subsection{CNN Models}

[Content for CNN models should be added here]
...
capture long-range dependencies and relationships within the image data.

\subsubsection{ViT Architecture Components}

The ViT architecture consists of the following main components:
...
The attention mechanism in ViT is computed as:
...
\subsubsection{ViT Hyperparameters}

\begin{table}[htbp]
    \centering
    \begin{tabular}{|l|c|c|}
        \hline
        \textbf{Hyperparameter}          & \textbf{Vision Transformer (ViT-B32)} & \textbf{DeiT (DeiT-B16)} \\
        \hline
        ...
        \hline
        Output layer Activation Function & GELU                              & GELU                   \\
        \hline
        Learning Rate Scheduler          & CosineAnnealingLR                 & CosineAnnealingLR      \\
        \hline
        Early Stopping Patience          & 10                                & 10                     \\
        \hline
    \end{tabular}
    \caption{Hyperparameters for Vision Transformer Models (ViT-B32 and DeiT-B16)}
    \label{tab:vit_hyperparameters}
\end{table}

\subsubsection{Cosine Annealing Learning Rate Scheduler}

The Cosine Annealing Learning Rate Scheduler is a type of learning rate scheduler that
is used to adjust the learning rate of the model during training. It is a type of
learning rate scheduler that is used to adjust the learning rate of the model during
training. It is a type of learning rate scheduler that is used to adjust the learning
rate of the model during training. It is a type of learning rate scheduler that is
used to adjust the learning rate of the model during training.


\subsubsection{GELU Activation Function}

The GELU Activation Function is a type of activation function that is used to
introduce non-linearity into the model. It is a type of activation function that is
used to introduce non-linearity into the model. It is a type of activation function
that is used to introduce non-linearity into the model. It is a type of activation
function that is used to introduce non-linearity into the model.
...
\subsubsection{Key Features of DeiT}

The main features of DeiT include:

\begin{itemize}
    \item \textbf{Distillation Token:} DeiT introduces a special token called the 
        distillation token, which is used to aggregate information from the entire image. 
        This token is trained to capture global context and is particularly useful for 
        improving the model's performance on smaller datasets.

    \item \textbf{Knowledge Distillation:} DeiT employs a distillation loss during 
        training, which encourages the model to learn from a teacher model (often a 
        pre-trained CNN) to improve its performance. This distillation process helps 
        the DeiT model to better capture the features and patterns present in the 
        training data, leading to improved classification accuracy.

    \item \textbf{Data Efficiency:} One of the key advantages of DeiT is its ability 
        to achieve competitive performance on image classification tasks with 
        significantly fewer training samples compared to vanilla ViT models. This is 
        particularly beneficial in scenarios where labeled data is limited, such as 
        in the case of anomaly detection in floating solar PVs.
\end{itemize}
...
\subsubsection{Mathematical Foundations of DeiT}
...
\paragraph{Image Patching and Embedding}
...
\paragraph{Patch and Position Embeddings}
...
\paragraph{Distillation Mechanisms}

\textbf{Hard Distillation Loss:}
...
\paragraph{Distillation Token Interaction}
...
include accuracy, precision, recall, F1-score, and area under the ROC curve (AUC-ROC). 
...
\section{Visualization and Analysis Techniques}
...
t-SNE helps address the challenge of understanding high-dimensional feature representations by:
