...
\begin{table}[H]
\centering
\caption{Comparison of Land-based and Floating PV Systems}
\label{tab:land_vs_floating_pv}
\begin{tabular}{lcc}
\toprule
\textbf{Characteristics} & \textbf{Land-based PV} & \textbf{Floating PV} \\
\midrule
Efficiency Improvement & Baseline & 5-15\% higher \\
Water Evaporation Reduction & N/A & 42-83\% \\
Land Use & High requirement & Zero requirement \\
Energy Payback Time & 1.5-2 years & 1.3 years \\
Cooling Effect & Natural air & Water cooling \\
Installation Complexity & Low & Moderate-High \\
\bottomrule
\end{tabular}
\end{table}

Table \ref{tab:land_vs_floating_pv} summarizes the key differences between land-based and floating PV systems. The advantages of FPV systems are particularly evident in their enhanced efficiency due to water cooling, significant water conservation benefits, and elimination of land use competition.
...
\begin{table}[H]
\centering
\caption{Classification of PV System Anomalies}
\label{tab:anomaly_classification}
\begin{tabular}{llcc}
\toprule
\textbf{Category} & \textbf{Anomaly Type} & \textbf{Impact Level} & \textbf{Detection Method} \\
\midrule
Thermal & Hot Spots & High & IR Thermography \\
& Cell Overheating & Medium & IR Thermography \\
\midrule
Physical & Cell Cracks & High & EL/Visual \\
& Module Damage & High & Visual \\
\midrule
Environmental & Soiling & Medium & Visual/IR \\
& Shading & Medium & Visual/IR \\
& Vegetation & Medium & Visual \\
\midrule
Electrical & Diode Failure & High & EL/Electrical \\
& Module Disconnection & High & Electrical \\
\bottomrule
\end{tabular}
\end{table}

Table \ref{tab:anomaly_classification} provides a systematic classification of the various anomaly types that can affect PV systems, along with their typical impact levels and the most suitable detection methods for each category.
...
\toprule
\textbf{Method} & \textbf{Cost} & \textbf{Speed} & \textbf{Accuracy} & \textbf{Scalability} & \textbf{Automation} \\
\midrule
Visual Inspection & Low & Low & Medium & Low & Low \\
IR Thermography & Medium & High & High & High & High \\
EL Imaging & High & Low & Very High & Low & Medium \\
Machine Learning & Medium & Very High & Very High & Very High & Very High \\
\bottomrule
\end{tabular}
\end{table}

Table \ref{tab:detection_methods} compares the various anomaly detection methods across multiple criteria. Machine learning approaches demonstrate superior performance in terms of speed, accuracy, scalability, and automation potential, making them particularly suitable for large-scale PV monitoring applications.
