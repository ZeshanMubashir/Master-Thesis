...
What will be the impact of the results? How is Deit better than ViT for detecting solar PV anomalies?
...
Gitstash is a good model for detecting solar PV anomalies.

Now we need to compare the results of Gitstash with the results of ViT and ResNet50.
we need to use the same dataset and the same evaluation metrics.
